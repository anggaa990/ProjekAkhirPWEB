...
<head>
    ...
    <title>Edit Kategori - Restoranku</title>
    ...
    <div class="container">
        <div class="card">
            ...
            <p class="card-subtitle">
                Perbarui informasi kategori <span class="category-name">"{{ $category->name }}"</span>
            </p>

            <div class="info-box">
                <i class="fas fa-info-circle"></i>
                Kategori ini memiliki <strong>{{ $category->menus->count() }} menu</strong>. Perubahan nama kategori akan terlihat di semua menu terkait.
            </div>
