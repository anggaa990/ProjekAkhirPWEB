        ...
        <div class="card">
            ...
            <form action="/admin/menus" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Nasi Goreng Spesial" required>
                    @error('name')
                    <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Deskripsi menu (opsional)">{{ old('description') }}</textarea>
                    @error('description')
                    <div class="error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price') }}" placeholder="25000" min="0" step="0.01" required>
                        @error('price')
                        <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock" name="stock" value="{{ old('stock', 0) }}" placeholder="50" min="0" required>
                        @error('stock')
                        <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
