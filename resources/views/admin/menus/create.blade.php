...
<head>
    ...
    <title>Tambah Menu - Restoranku</title>
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <p class="card-subtitle">Tambahkan menu makanan atau minuman baru ke dalam sistem restoran</p>
            ...
            <form action="{{ route('admin.menus.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <div class="form-hint">
                        <i class="fas fa-info-circle"></i> Pilih kategori yang sesuai untuk menu ini
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="name" 
                        value="{{ old('name') }}" 
                        placeholder="Contoh: Nasi Goreng Spesial, Burger Beef, Pizza Margherita"
                        required
                        autofocus
                    >
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        id="description" 
                        name="description" 
                        placeholder="Deskripsi lengkap tentang menu, bahan yang digunakan, atau keunikan menu (opsional)"
                    ...
                    @enderror
                    <div class="form-hint">
                        <i class="fas fa-info-circle"></i> Deskripsikan menu dengan menarik untuk menarik pelanggan
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <div class="form-hint">
                        <i class="fas fa-info-circle"></i> Masukkan URL gambar menu (opsional). Gunakan link dari Unsplash, Imgur, atau sumber lainnya
                    </div>
                </div>
